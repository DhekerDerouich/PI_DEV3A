...
public class FinanceController implements Initializable {
    ...
    private void loadDepenses() {
        ...
        loadViewInSection("/view/DepenseTableView.fxml", "depenses");
    ...
    private void loadRevenus() {
        ...
        loadViewInSection("/view/RevenuTableView.fxml", "revenus");
    ...
    private void loadViewInSection(String fxmlPath, String type) {
        try {
            ...
            // Passer la référence du contrôleur principal si nécessaire
