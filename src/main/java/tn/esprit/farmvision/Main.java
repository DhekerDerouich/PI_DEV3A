...
public class Main extends Application {
    ...
    public void start(Stage primaryStage) {
        try {
            ...
            System.out.println("📄 CHEMIN EXACT CHARGÉ: " + loginUrl); // ← AJOUTER
    ...
    private URL findFXML(String fileName) {
        // Tous les chemins possibles pour les FXML
        String[] searchPaths = {
                // Chemins du module COM
                "/com/pi/view/" + fileName,
                "/tn/esprit/farmvision/com/pi/view/" + fileName,

                // Chemins du module gestionuser
                "/fxml/" + fileName,
    ...
    private void redirectToAppropriateDashboard(Stage stage, Utilisateur user) throws Exception {
        ...
        switch (role) {
            ...
            case "ResponsableExploitation":
                // ✅ Responsable → Dashboard principal du module COM
                fxmlPath = "main.fxml";
        ...
        // Charger le CSS pour cette scène aussi
        loadCSS(scene);
